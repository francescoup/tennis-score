<template>
  <div
    class="h-full w-full bg-yellow-400/8 absolute top-0 left-0 flex justify-center items-center"
    aria-labelledby="inizia partita"
    role="dialog"
    aria-modal="true"
  >
    <div
      class="h-full w-full md:h-auto md:w-86 bg-white p-10 md:rounded-xl md:shadow-2xl"
    >
      ciao sono un modal
